...
import { MapPin, Plus, Trash2, Send, ShoppingBag, User, Store } from 'lucide-react';
...
const Order = () => {
  ...
  const handleSubmit = (e) => {
    ...
    console.log("=== NEW SALT ORDER SUBMITTED ===");
    console.log(JSON.stringify(finalOrderData, null, 2));
    alert("Order data has been logged to the console successfully!");
  };
      ...
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
        ...
        <form onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-10">
          ...
          <div className="pt-6 border-t border-gray-200">
            <button
              type="submit"
              className="w-full sm:w-auto ml-auto flex items-center justify-center gap-2 bg-[#04469b] hover:bg-[#033678] text-white px-8 py-3.5 rounded-xl font-bold shadow-lg shadow-[#04469b]/30 hover:shadow-[#04469b]/40 transition-all active:scale-95"
            >
